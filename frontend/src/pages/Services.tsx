...
const services = [
  {
    ...
    img: "/images/Full Truckload (FTL).png",
  },
  {
    icon: Package,
    ...
    img: "/images/Less Than Truckload (LTL).png",
  },
  {
    icon: MapPin,
  ...
  },
  {
    ...
    img: "/images/Long Distance Transport.png",
  },
  {
    icon: Snowflake,
  ...
  return (
    <div>
      ...
      <section className="section-padding section-light relative overflow-hidden">
        ...
        {/* Last card left-aligned on its own row */}
        <div className="container mx-auto max-w-7xl relative z-10 mt-6 lg:mt-8">
